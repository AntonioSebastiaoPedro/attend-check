    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3 font-weight-bold text-dark mb-0">Nova Turma</h1>
                    ...
                    <form method="POST" action="{{ route('classes.store') }}">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input
                                ...
                                placeholder="Ex: Programação Web I"
                            >
                            @error('name')
                        ...
                        <div class="form-row mb-4">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                >
                                    <option value="1" {{ old('semester') == 1 ? 'selected' : '' }}>1º Semestre</option>
                                    <option value="2" {{ old('semester') == 2 ? 'selected' : '' }}>2º Semestre</option>
                                </select>
                                @error('semester')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
